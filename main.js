...
if (anu.action == 'add' && !mem.includes(herman.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                tekss = `*彡 - GiiXyz*`
                welcomeBut = [{buttonId:`#y`,buttonText:{displayText:'Hii. 🤗'},type:1}]
            ...
            if (anu.action == 'remove' && !mem.includes(herman.user.jid)) {
                ...
                goodbyeButt = { contentText: `${out}`, footerText: `*彡 - GiiXyz*`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
